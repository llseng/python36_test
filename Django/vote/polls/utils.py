...
# @LastEditors: llseng
# @LastEditTime: 2021-02-06 11:42:50
#
...
class Captcha:
    ...
    def __init__(self, width, height, fonts=None, color=None):
        ...
        self._fonts = fonts if fonts else \
            [os.path.join(os.path.dirname(__file__), 'fonts', font) for font in ['1.ttf', '2.ttf', '3.ttf', '4.ttf', '5.ttf', '6.ttf']]
    ...
    def _text(self,
        ...
        for char_image in char_images:
            ...
            self._image.paste(char_image, (offset, int(
                (height - c_height) / 2)), mask)
